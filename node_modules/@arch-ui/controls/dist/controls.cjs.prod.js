...
const Wrapper = styled.div({
  ...
  let {checked: checked, isDisabled: isDisabled, isFocus: isFocus, isActive: isActive, isHover: isHover} = _ref, bg = theme.colors.N10;
...
class Control extends React.Component {
  ...
  render() {
    ...
    return React__default.createElement(components.Wrapper, wrapperProps, React__default.createElement(reactPseudoState.PseudoState, null, (_ref2, snapshot) => {
      let {onBlur: onBlur, onFocus: onFocus, onKeyDown: onKeyDown, onKeyUp: onKeyUp, onMouseDown: onMouseDown, onMouseEnter: onMouseEnter, onMouseLeave: onMouseLeave, onMouseUp: onMouseUp, onTouchEnd: onTouchEnd, onTouchStart: onTouchStart} = _ref2;
      const labelHandlers = {
...
const Svg = _ref3 => {
  let {html: html} = _ref3, props = _objectWithoutProperties(_ref3, [ "html" ]);
