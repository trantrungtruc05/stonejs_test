...
const PRIMARY_NAV_GUTTER = 2 * theme.gridSize, NavGroupIcons = styled.div({
  ...
  let {hasScroll: hasScroll, isBottom: isBottom, isScrollable: isScrollable} = _ref;
  const divider = {
  ...
  let {depth: depth, isSelected: isSelected, mouseIsOverNav: mouseIsOverNav} = _ref2;
...
}), NavIcon = styled(ItemElement)(_ref3 => {
  let {mouseIsOverNav: mouseIsOverNav} = _ref3;
  return {
...
}), PrimaryNavHeading = styled.h3(_ref4 => {
  let {depth: depth} = _ref4;
  return {
