...
const CheckMark = _ref => {
  let bg, fg, border, {isDisabled: isDisabled, isFocused: isFocused, isSelected: isSelected} = _ref;
  ...
  let {children: children, isDisabled: isDisabled, innerProps: innerProps, innerRef: innerRef} = _ref2;
  ...
  let {selectProps: selectProps} = _ref3, props = _objectWithoutProperties(_ref3, [ "selectProps" ]);
  ...
  let {displaySearch: displaySearch, innerRef: innerRef, components: propComponents} = _ref4, props = _objectWithoutProperties(_ref4, [ "displaySearch", "innerRef", "components" ]);
